...
const projects = [
  ...
  },
  {
    id: 2,
    name: "Bucket",
    description: "A social media site with the goal of connecting like-minded individuals and helping them check off their bucket list items.",
  ...
  },
  {
    ...
    bp1: "Developed the technology responsible for searching a keyword, creating 3 new results that populate the page simultaneously.",
    bp2: "Built the logic behind the save function that utilized the clients local storage.",
    bp3: " Implemented the dynamic population of the users 'Favorites' page, pulling the previously saved results onto a sortable gallery page.",  
  },
  // {
  //   id: 3,
  ...
  // },
  {
    ...
    bp2: "Created a Node.js command-line application that takes in information about a team, gathered using the npm package Inquirer.",
    bp3: "converted that information into a dynamically generated html profile page.",  
